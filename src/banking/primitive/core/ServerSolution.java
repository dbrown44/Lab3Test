...
class ServerSolution implements AccountServer {
	...
	private boolean checkForDuplicate(String acctName, Map<String,Account> acctMap){
		for(String name : acctMap.keySet()){
	...
	private boolean newAccountFactory(String type, String name, float balance)
		...
		if ("Checking".equals(type)) {
			//SER316: Task 1, Step 3 call
			if(checkForDuplicate(name, accountMap)){
